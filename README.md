...
One thing that I should have genericized more was the terminology used by the site code for star ratings and the like.
Cape Jeer doesn’t award “stars”, it awards “capes”, plus a secondary rating called “tents” (for a movie’s *camp value*), and a couple of additional awards besides.
For another review site with a different subject matter, different terms should be used.
I defined named constants for several personal values, but I didn’t cover those.
